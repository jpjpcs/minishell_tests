...
int	expand_line(char *key, int i, int j, char **line)
{
	...
	tmp = ft_substr(*line, 0, i); // Extrai a parte da linha antes do índice 'i'. O indíce i (temp -sh->line) é a diferença entre a localização onde está o espaço (indíce 4 por exemplo se o espaço estiver na posição 4)
